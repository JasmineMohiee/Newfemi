        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Clothing/Blouse
                    <span></span> White Flowers Blouse
                </div>
            </div>
        </div>
                            ...
                            <div class="row mb-50">
                                      ...
                                      <div class="slider-nav-thumbnails pl-15 pr-15">
                                        <div><img src="{{ asset('assets/imgs/shop/product-16-2.jpg') }}" alt="product image"></div>
                                         <div><img src="{{ asset('assets/imgs/shop/product-16-1.jpg') }}" alt="product image"></div>
                                          ...
                                          <div><img src="{{ asset('assets/imgs/shop/product-16-4.jpg') }}" alt="product image"></div>
                                           <div><img src="{{ asset('assets/imgs/shop/product-16-5.jpg') }}" alt="product image"></div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        <h2 class="title-detail">White Flowers Blouse</h2>
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Category: <a href="shop.html">Women's Clothing</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">238.85L.E</span></ins>
                                                <ins><span class="old-price font-md ml-15">245.8L.E</span></ins>
                                                <span class="save-price  font-md color3 ml-15">25% Off</span>
                                            </div>
                                        </div>
                                        <div class="bt-1 border-color-1 mt-15 mb-15"></div>
                                        <div class="short-desc mb-30">
                                            <p> White flowers blouse.
                                              </p>
                                        </div>
                                        <div class="product_sort_info font-xs mb-30">
                                            <ul>
                                                <li class="mb-10"><i class="fi-rs-crown mr-5"></i> No Warranty</li>
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li class="mb-5">Tags: <a href="#" rel="tag">Cloth</a>, <a href="#" rel="tag">Women</a>, <a href="#" rel="tag">Blouse</a> </li>
                            ...
                            <div class="tab-style3">
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    <div class="tab-pane fade show active" id="Description">
                                        <div class="">
                                            <p> White blouse with some flowers on top, 100% cotton.</p>
                                            
                                            <ul class="product-more-infor mt-30">
                                                <li><span>Type Of Packing</span> Box</li>
                                                <li><span>Color</span> Green, Pink, Powder Blue, Purple</li>
                                                <li><span>Quantity Per Case</span> 25 pieces</li>
                                            ...
                                            <p> Shipping to all around Egypt & Packaging in box with some gifts.
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    ...
                                                                    <h6><a href="#">Aliaa</a></h6>
                                                                    <p class="font-xxs">Since 2022</p>
                                                                </div>
                                                                <div class="desc">
                                                                    <div class="product-rate d-inline-block">
                                                                        <div class="product-rating" style="width:90%">
                                                                    ...
                                                                    <p>Thank you very fast shipping.</p>
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                ...
                                                                <div class="desc">
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex align-items-center">
                                                                            <p class="font-xs mr-30">March 4, 2022 at 3:12 pm </p>
                                                                            <a href="#" class="text-brand btn-reply">Reply <i class="fi-rs-arrow-right"></i> </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                ...
                                                                <div class="desc">
                                                                    ...
                                                                    <p>Authentic and Beautiful, Love these way more than ever expected This is great blouse</p>
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex align-items-center">
                                                                            <p class="font-xs mr-30">May 4, 2022 at 3:12 pm </p>
                                                                            <a href="#" class="text-brand btn-reply">Reply <i class="fi-rs-arrow-right"></i> </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="row related-products">
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="product-details.html" tabindex="0">Colorful Pants</a></h2>
                                                    ...
                                                    <div class="product-price">
                                                        <span>238.85L.E </span>
                                                        <span class="old-price">245.8L.E</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="product-details.html" tabindex="0">Gold Hoop Earrings</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up mb-0">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="product-details.html" tabindex="0">Colorful Flowers Pants</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>100L.E </span>
                                                        <span class="old-price">120L.E</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">99.50L.E</p>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">200L.E</p>
                                    <div class="product-rate">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">150L.E</p>
                                    <div class="product-rate">
