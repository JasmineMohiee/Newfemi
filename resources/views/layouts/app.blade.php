                    ...
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                ...
                                <li><a href="shop.html"><i class="surfsidemedia-font-cpu"></i>Electronics Accessories</a></li>
                                <li><a href="shop.html"><i class="surfsidemedia-font-home"></i>Jewelery & Accessories</a></li>
                                <li><a href="shop.html"><i class="surfsidemedia-font-high-heels"></i>Shoes</a></li>
                                <li><a href="shop.html"><i class="surfsidemedia-font-teddy-bear"></i>Mothers & Kids</a></li>
                                <li><a href="shop.html"><i class="surfsidemedia-font-kite"></i>Watches</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- mobile menu start -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@femiforce.in
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Femi Force</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
