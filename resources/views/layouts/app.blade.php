...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/imgs/theme/favicon.jpg')}}">
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="position-static"><a href="#">Our Collections <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    <li><a href="product-details.html">Laptops</a></li>
                                    ...
                                    <li><a href="{{route('contact')}}">Contact</a></li>
                                     @auth
                                    <li><a href="{{route('my-account')}}">My Account<i class="fi-rs-angle-down"></i></a>
                    ...
                    <div class="col-lg-7 mb-md-3 mb-lg-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col my-4 my-md-0 des">
                                <h5 class="font-size-15 ml-4 mb-0">...and receive <strong>25LE coupon for first shopping.</strong></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Alexandria.Egypt
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+1 0000-000-000
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@femiforce.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">FemiForce</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
